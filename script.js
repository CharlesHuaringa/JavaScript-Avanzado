...
//     let valitInput = ["type", "base_damage", "base_hp", "speed"]

//     if(valitInput.includes(argument)){
...
// function filtrarpokemons(argument){
...
//         let total_damage = selectpokemon.base_damage + Math.floor(Math.random() * (selectpokemon.max_damage-1+selectpokemon.min_damage)+selectpokemon.min_damage)
//         console.log(total_damage)
//     }else{
//         console.log(`Ingrese un numero que no sea mas grande que ${pokemons.length - 1}`)
//     }
...
//         let valitInput = ["daño", "base_damage", "base_hp", "speed"]
//         if(valitInput.includes(argument)){
//             atributos()
//             for(let i = 0; i < pokemons.length; i++){
...
//             console.log(result)
//         }else {
//             console.log("Ingresa un argumento valido por favor")
//         }
//     }